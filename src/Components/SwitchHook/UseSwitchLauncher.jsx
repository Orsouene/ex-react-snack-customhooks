...
function UseSwitchLauncher() {
  ...
  return (<> 
  <div className='bg-stone-100 w-fit p-10 rounded-xl m-auto mt-10 gap-1 flex border border-stone-950'>
      <p className='bg-stone-200 w-fit p-5 rounded-3xl '>{isOn ? "ON" :"OFF"} </p>
